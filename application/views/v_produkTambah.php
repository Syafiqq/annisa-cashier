                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo base_url('produk/tambahProduk'); ?>" method="POST" class="form-horizontal">
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls">
                                            <input name="idProduk" type="hidden" value="<?php echo $produk ?>" class="input-large" required="true" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select name="kategori" class="input-large m-wrap" tabindex="1" required="true">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label class="radio">
                                                <input type="radio" name="lacak" value="Ya">
                                                Ya
                                            </label>
                                            <label class="radio">
                                                <input type="radio" name="lacak" value="Tidak">
                                                Tidak
                                            </label>
                                        </div>
                                    </div>
