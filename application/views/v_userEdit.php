                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <form action="<?php echo base_url('user/editUser'); ?>" method="POST" class="form-horizontal">
                                <fieldset>
                                    <input name="id_user" type="hidden" value="<?php echo $data->id_user; ?>" class="input-large" required="true" readonly/>

                                    <div class="control-group">
                                        <label for="name" class="control-label">Nama</label>
                                        <div class="cinput-prepend">
                                            <input name="nama" type="text" placeholder="Isi disini" value="<?php echo $data->nama; ?>" class="input-large" required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <select name="level" class="input-large m-wrap" value="<? php echo $data->level;?>" tabindex="1" required="true">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="cinput-prepend">
                                            <input name="username" type="text" placeholder="Isi disini" value="<?php echo $data->username; ?>" class="input-large" required="true"/>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <input id="password" name="password" type="password" placeholder="Isi disini" value="" class="input-large" required="true"/>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">Level</label>
                                        <div class="input-prepend">
                                            <select name="id_outlet" class="input-large m-wrap">
                                                <?php foreach ($outlet as $dataoutlet) { ?>
                                                    <?php if ($dataoutlet->id_outlet == $data->id_outlet) { ?>
                                                        # code...
                                                        <option value="<?php echo $dataoutlet->id_outlet ?>" selected><?php echo $dataoutlet->nama_outlet; ?></option>
                                                    <?php } else { ?>
                                                        <option value="<?php echo $dataoutlet->id_outlet ?>"><?php echo $dataoutlet->nama_outlet; ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <input id="telepon" name="telepon" type="text" value="<?php echo $data->telepon; ?>" placeholder="" class="input-medium" required="true">
                                        </div>
                                    </div>
