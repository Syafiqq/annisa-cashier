                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <?php foreach ($bahanBaku as $data) { ?>
                                <form action="<?php echo base_url('bahanBaku/tambahSin'); ?>" method="POST" class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="jumlah" type="text" placeholder="Isi disini" class="input-medium" required="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="" name="harga" type="text" placeholder="Isi disini" class="input-medium" required="true"/>
                                            </div>
                                        </div>
