                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo base_url('outlet/tambahOutlet'); ?>" method="POST" class="form-horizontal">
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls">
                                            <input name="idOutlet" type="hidden" value="<?php echo $outlet ?>" class="input-large" required="true" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="namaOutlet" type="text" placeholder="Isi disini" class="input-large" required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="alamat" type="text" placeholder="Isi disini" class="input-large" required="true"/>
                                        </div>
                                    </div>
