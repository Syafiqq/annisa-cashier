                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <?php foreach ($bahanBaku as $data) { ?>
                                <form action="<?php echo base_url('bahanBaku/editBahan'); ?>" method="POST" class="form-horizontal">
                                    <fieldset>
                                        <input name="idBahan" type="hidden" value="<?php echo $data->id_bahan; ?>" class="input-large" required="true" readonly/>

                                        <div class="control-group">
                                            <label for="name" class="control-label">Nama Bahan</label>
                                            <div class="controls">
                                                <input name="namaBahan" type="text" placeholder="Isi disini" value="<?php echo $data->nama_bahan; ?>" class="input-large" required="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="satuan" class="input-large m-wrap" value="<? php echo $data->satuan;?>" tabindex="1" required="true">
