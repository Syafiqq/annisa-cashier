                            ...
                            <form action="<?php echo base_url('user/tambahUser'); ?>" method="POST" class="form-horizontal">
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls">
                                            <input name="idUser" type="hidden" value="<?php echo $pengguna ?>" class="input-large" required="true" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <input name="nama" type="text" placeholder="Isi disini" class="input-large" required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <select name="level" class="input-large m-wrap" tabindex="1" required="true">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <input name="username" type="text" placeholder="Isi disini" class="input-medium" required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <input id="password" name="password" type="password" placeholder="Isi disini" class="input-medium" required="true"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <select id="id_outlet" name="outlet" class="input-large m-wrap" tabindex="1" required="true">
                                                <?php foreach ($outlet as $ol) { ?>
                                                    <option value="<?php echo $ol->id_outlet; ?>"><?php echo $ol->nama_outlet; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="input-prepend">
                                            <input name="telepon" type="text" placeholder="Isi disini" class="input-medium" required="true">
                                        </div>
                                    </div>
