                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <?php foreach ($produk as $data) { ?>
                                <form action="<?php echo base_url('produk/editProduk'); ?>" method="POST" class="form-horizontal">
                                    <fieldset>
                                        <input name="idProduk" type="hidden" value="<?php echo $data->id_produk; ?>" class="input-large" required="true" readonly/>

                                        <div class="control-group">
                                            <label for="name" class="control-label">Nama Produk</label>
                                            <div class="controls">
                                                <input name="namaProduk" type="text" placeholder="Isi disini" value="<?php echo $data->nama_produk; ?>" class="input-large" required="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="kategori" class="input-large m-wrap" value="<? php echo $data->kategori;?>" tabindex="1" required="true">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input id="harga" name="harga" type="text" value="<?php echo $data->harga_jual; ?>" placeholder="" class="input-small" required="true">
                                            </div>
                                        </div>

                                        <div class="control-group">
                                            <label class="control-label">Lacak Stok</label>
                                            <div class="controls">
                                                <label class="radio">
                                                    <input type="radio" name="lacak" value="Ya" checked="<?php if ($data->lacak == "Ya") echo "checked" ?>">
                                                    Ya
                                                </label>
                                                <label class="radio">
                                                    <input type="radio" name="lacak" value="Tidak" checked="<?php if ($data->lacak == "Tidak") echo "checked" ?>">
                                                    Tidak
                                                </label>
                                            </div>
                                        </div>
