                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <div class="portlet-body">
                                <div class="clearfix">
                                    <div class="btn-group">
                                        <a href="<?php echo site_url('admin/outlet/tambah'); ?>">
                                ...
                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                    ...
                                    foreach ($outlet as $data)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('admin/outlet/edit/' . $data->id_outlet); ?>" class="edit"> Edit</a>
                                            </td>
                                            <td>
                                                <a href="<?php echo base_url('admin/outlet/hapus/' . $data->id_outlet); ?>" class="delete"> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
