                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <?php foreach ($outlet as $data) { ?>
                                <form action="<?php echo base_url('outlet/editOutlet'); ?>" method="POST" class="form-horizontal">
                                    <fieldset>
                                        <input name="idOutlet" type="hidden" value="<?php echo $data->id_outlet; ?>" class="input-large" required="true" readonly/>

                                        <div class="control-group">
                                            <label for="name" class="control-label">Nama Outlet</label>
                                            <div class="controls">
                                                <input name="namaOutlet" type="text" placeholder="Isi disini" value="<?php echo $data->nama_outlet; ?>" class="input-large" required="true"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input name="alamat" type="text" placeholder="Isi disini" value="<?php echo $data->alamat; ?>" class="input-large" required="true"/>
                                            </div>
                                        </div>
