            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="#">Daftar Bahan Baku</a>
                            <span class="divider">&nbsp;</span>
                        </li>
                        <li>
                            <a href="#">Tambah Bahan Baku</a>
                ...
                <div class="span12 sortable">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo base_url('bahanBaku/tambahBahan'); ?>" method="POST" class="form-horizontal">
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls">
                                            <input name="idBahan" type="hidden" value="<?php echo $bahanBaku ?>" class="input-large" required="true" readonly/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input name="namaBahan" type="text" placeholder="Isi disini" class="input-large" required="true"/>
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label">Tipe Satuan</label>
                                        <div class="controls">
                                            <select name="satuan" class="input-large m-wrap" tabindex="1" required="true">
